...
public class CandidateService {
    ...
    public void candidateFactory() {
        this.candidateList.add(new Candidate(this.lastInsertedId, null, "Zé Rouba Fácil", "Promete transparência, mas esquece o que é vidro.", 0L));
        this.candidateList.add(new Candidate(this.lastInsertedId += 1, null, "Maria Mãos Leves", "Especialista em pegar oportunidades... e o que mais estiver solto.", 0L));
        this.candidateList.add(new Candidate(this.lastInsertedId += 1, null, "Tonho do Papo", "Fala bonito, mas o plano de governo é um PowerPoint vazio.", 0L));
        this.candidateList.add(new Candidate(this.lastInsertedId += 1, null,"Dona Promessa", "Promete até o impossível, e entrega panfletos.", 0L));
